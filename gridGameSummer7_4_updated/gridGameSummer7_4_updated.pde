...
void setup() {
  ...
  pythonResetAddress = new NetAddress("127.0.0.1", 6801); // NEW: Python reset address
...
void keyPressed() {
  ...
  if (key == 'r' || key == 'R') { //triggers sensor to recallibrate
    // calibration trigger for testing
    println("New Round");
